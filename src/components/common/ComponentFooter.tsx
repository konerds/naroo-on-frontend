...
const ComponentFooter: React.FC = () => {
  ...
  return (
    <div className="flex flex-wrap justify-center w-full bg-[#696969]">
      <div className="w-full h-[148px] sm:h-[128px] xl:max-w-[1152px] lg:max-w-[864px] md:max-w-[680px] sm:max-w-[504px] xs:max-w-[400px] flex justify-center items-center">
        <div className="xl:w-[250px] lg:w-[250px] md:w-[220px] sm:w-[210px] xs:w-[150px]">
          {!!dataFooterLogo &&
          !!!errorFooterLogo &&
          dataFooterLogo.length > 0 ? (
            <img
              className="cursor-pointer sm:w-[170px] xs:w-[100px]"
        ...
        <div className="xl:w-[950px] lg:w-[660px] md:w-[480px] sm:w-[320px] xs:w-[260px]">
          <div className="cursor-pointer text-[#bfbfbf] text-[0.875rem] font-light pb-[5px] leading-[1.25rem] border-b-[1px] border-solid border-[rgba(255,255,255,0.1)] box-border">
            이메일무단수집거부
          </div>
          <div className="border-t-[1px] border-solid border-[rgba(0,0,0,0.1)] box-border"></div>
          <div className="pt-[5px] text-[#bfbfbf] text-[0.875rem] font-light">
